...
import {
    ...
    Trophy, AlertCircle, ChevronLeft, Brain, Zap, ChevronDown, ChevronRight, TrendingUp, Trash2
} from 'lucide-react';
...
export default function QuizView({ moduleId, onBack }: { moduleId: string | null, onBack?: () => void }) {
    ...
    const handleDeleteModule = async (e: React.MouseEvent, id: string, title: string) => {
        e.stopPropagation();
